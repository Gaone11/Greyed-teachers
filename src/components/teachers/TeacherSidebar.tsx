  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto pt-4 py-3 px-3 space-y-1">
          ...
          return (
            ...
            >
              <div className={`relative flex items-center justify-center ${!isCollapsed || isMobile ? 'mr-3' : 'mr-0'}`}>
                <Icon className={`${isMobile ? 'w-6 h-6' : 'w-5 h-5'} ${isActive ? 'text-greyed-navy' : 'text-premium-neutral-600 group-hover:text-greyed-navy'} transition-colors duration-200`} />
                {item.special && (
        ...
        >
          <div className={`relative flex items-center justify-center ${!isCollapsed || isMobile ? 'mr-3' : 'mr-0'}`}>
            <Settings className={`${isMobile ? 'w-6 h-6' : 'w-5 h-5'} ${activePage === 'settings' ? 'text-greyed-navy' : 'text-premium-neutral-600 group-hover:text-greyed-navy'} transition-colors duration-200`} />
          </div>
          {(!isCollapsed || isMobile) && (
      ...
      <div className={`${isMobile ? 'p-4' : 'p-3'} border-t border-premium-neutral-200`}>
        ...
        >
          <div className={`flex items-center justify-center ${!isCollapsed || isMobile ? 'mr-3' : 'mr-0'}`}>
            <LogOut className={`${isMobile ? 'w-6 h-6' : 'w-5 h-5'} text-premium-neutral-600 group-hover:text-greyed-navy transition-colors duration-200`} />
          </div>
          {(!isCollapsed || isMobile) && (
