...
interface TeacherSidebarProps {
  activePage: 'dashboard' | 'classes' | 'lesson-planner' | 'assessments' | 'tutors' | 'settings' | 'el-ai' | 'grey-ed-ta' | 'courses' | 'admin-kb' | 'knowledge' | 'knowledgebase';
  onLogout: () => void;
  collapsed?: boolean;
        ...
        <div className={`${isMobile ? 'pt-6 px-4 pb-4' : 'pt-4 px-4 pb-4'} border-b border-premium-neutral-200`}>
          <div className="flex items-center gap-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-premium-neutral-500 mt-0.5">We are learning</p>
            </div>
            {!isMobile && (
              <button
