...
const curriculumOptions: CurriculumOption[] = [
  { country: 'International', curricula: ['IB PYP', 'IB MYP', 'IB Diploma Programme', 'Cambridge Primary', 'Cambridge Lower Secondary', 'IGCSE', 'Cambridge AS & A Level'] },
  { country: 'South Africa', curricula: ['CAPS', 'IEB', 'Cambridge International'] },
  { country: 'United Kingdom', curricula: ['National Curriculum', 'GCSE', 'A Level', 'Scottish Curriculum for Excellence'] },
  { country: 'United States', curricula: ['Common Core', 'NGSS', 'Advanced Placement', 'State Standards'] },
  { country: 'India', curricula: ['CBSE', 'ICSE', 'ISC', 'State Boards'] },
  { country: 'Australia', curricula: ['Australian Curriculum', 'NSW HSC', 'VCE', 'QCE', 'WACE'] },
  { country: 'Canada', curricula: ['Ontario Curriculum', 'British Columbia Curriculum', 'Alberta Curriculum', 'Quebec Education Program'] },
  { country: 'Nigeria', curricula: ['National Curriculum', 'WAEC', 'NECO', 'Cambridge International'] },
  { country: 'Kenya', curricula: ['CBC', 'KCSE', 'Cambridge International'] },
  { country: 'Ghana', curricula: ['NaCCA Curriculum', 'WASSCE', 'Cambridge International'] },
  { country: 'Singapore', curricula: ['MOE Syllabus', 'GCE O-Level', 'GCE A-Level', 'IB Diploma Programme'] },
  { country: 'France', curricula: ['French National Curriculum', 'Brevet', 'Baccalaureate'] },
  { country: 'Germany', curricula: ['Grundschule', 'Gymnasium', 'Realschule', 'Abitur'] },
  { country: 'United Arab Emirates', curricula: ['UAE MOE', 'British Curriculum', 'American Curriculum', 'IB Diploma Programme'] }
];
...
const AssessmentLibraryPage: React.FC = () => {
  ...
  const [curriculum, setCurriculum] = useState('IB Diploma Programme');
