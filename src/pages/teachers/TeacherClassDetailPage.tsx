...
const TeacherClassDetailPage: React.FC = () => {
  ...
  const toggleSidebar = () => {
    ...
    try { localStorage.setItem('teacherSidebarCollapsed', String(newState)); } catch { /* private browsing */ }
  };
    ...
    >
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 mb-4">
            <div className="flex flex-col md:flex-row justify-between">
              <div>
                <h1 className="text-xl md:text-2xl font-headline font-bold text-text">
              ...
              <div className="mt-4 md:mt-0 flex space-x-3">
                <button
                  ...
                  className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors flex items-center shadow-sm"
                >
          ...
          <div className="bg-white rounded-xl shadow-sm mb-4">
            <div className="border-b border-premium-neutral-200">
              <nav className="flex overflow-x-auto">
                <a
                  href="#documents"
                  className={`px-4 py-3 text-sm font-medium relative ${activeTab === 'documents' ? 'text-primary' : 'text-text hover:text-primary/70'}`}
                ...
                <a
                  href="#lesson-plans"
                  className={`px-4 py-3 text-sm font-medium relative ${activeTab === 'lesson-plans' ? 'text-primary' : 'text-text hover:text-primary/70'}`}
                ...
                <a
                  href="#assessments"
                  className={`px-4 py-3 text-sm font-medium relative ${activeTab === 'assessments' ? 'text-primary' : 'text-text hover:text-primary/70'}`}
                ...
                <a
                  href="#analytics"
                  className={`px-4 py-3 text-sm font-medium relative ${activeTab === 'analytics' ? 'text-primary' : 'text-text hover:text-primary/70'}`}
                ...
                <a
                  href="#notes"
                  className={`px-4 py-3 text-sm font-medium relative ${activeTab === 'notes' ? 'text-primary' : 'text-text hover:text-primary/70'}`}
            ...
            <div className="p-4">
              ...
              {activeTab === 'lesson-plans' && (
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold text-text">Lesson Plans</h2>
                    <div className="flex space-x-2">
                      <Link
                        to="/teachers/lesson-planner"
                        className="px-3 py-1.5 bg-primary text-white rounded hover:bg-primary/90 text-sm transition-colors flex items-center"
                      >
                        <PlusCircle size={14} className="mr-1" />
                        Generate New Plan
                      </Link>
                      <button className="px-3 py-1.5 bg-primary/10 text-primary rounded hover:bg-primary/20 text-sm transition-colors">
                        Import Plan
                      </button>
                    </div>
                  </div>
                  ...
                  {lessonPlans.length === 0 ? (
                    <div className="text-center py-10 border-2 border-dashed border-premium-neutral-200 rounded-lg">
                      <BookMarked className="w-12 h-12 text-primary/30 mx-auto mb-4" />
                      <h3 className="text-lg font-medium text-text mb-2">No lesson plans yet</h3>
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                          <tr className="bg-primary/5">
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Date</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Topic</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Status</th>
                            <th scope="col" className="px-4 py-3 text-right text-xs font-medium text-text uppercase tracking-wider">Actions</th>
                          </tr>
                        </thead>
                            ...
                            <tr key={plan.id} className="hover:bg-primary/5">
                              ...
                              <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="text-primary hover:text-primary mx-1"
                                >
                                  View
                                </a>
                                <button className="text-primary hover:text-primary mx-1">Edit</button>
                              </td>
                            </tr>
                          ))}
                        </tbody>
              ...
              {activeTab === 'assessments' && (
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold text-text">Assessments</h2>
                    <div className="flex space-x-2">
                      <Link
                  ...
                  {assessments.length === 0 ? (
                    <div className="text-center py-10 border-2 border-dashed border-premium-neutral-200 rounded-lg">
                      ...
                      <h3 className="text-lg font-medium text-text mb-2">No assessments yet</h3>
                      <p className="text-text-muted max-w-md mx-auto mb-4">
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                          <tr className="bg-primary/5">
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Title</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Date</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">Status</th>
                            <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-text uppercase tracking-wider">AI Generated</th>
                            <th scope="col" className="px-4 py-3 text-right text-xs font-medium text-text uppercase tracking-wider">Actions</th>
                          </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                          {assessments.map((assessment) => (
                            <tr key={assessment.id} className="hover:bg-primary/5">
                              <td className="px-4 py-3 whitespace-nowrap">
                                <div className="font-medium text-primary hover:text-primary cursor-pointer">
                                  {assessment.title}
                                </div>
                              </td>
                              <td className="px-4 py-3 whitespace-nowrap text-text">
                              ...
                              <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                                <button className="text-primary hover:text-primary mx-1">View</button>
                                <button className="text-primary hover:text-primary mx-1">Results</button>
                              </td>
                            </tr>
                          ))}
                        </tbody>
              ...
              {activeTab === 'analytics' && (
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold text-text">Class Analytics</h2>
                    <div className="flex space-x-2">
                      <button className="px-3 py-1.5 bg-primary/10 text-primary rounded hover:bg-primary/20 text-sm transition-colors">
                        Download Report
                      </button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="bg-white shadow-sm border border-premium-neutral-200 rounded-lg p-4">
                      <h3 className="font-medium text-sm text-text-muted mb-1">Average Grade</h3>
                      <p className="text-2xl font-bold text-text">{analytics?.averageGrade || 0}%</p>
                      <div className="mt-2 text-xs text-green-600">+3% from previous unit</div>
                    </div>

                    <div className="bg-white shadow-sm border border-premium-neutral-200 rounded-lg p-4">
                      <h3 className="font-medium text-sm text-text-muted mb-1">Engagement Rate</h3>
                      <p className="text-2xl font-bold text-text">{analytics?.engagementRate || 0}%</p>
                      <div className="mt-2 text-xs text-green-600">High participation</div>
                    </div>

                    <div className="bg-white shadow-sm border border-premium-neutral-200 rounded-lg p-4">
                      <h3 className="font-medium text-sm text-text-muted mb-1">Homework Completion</h3>
                      <p className="text-2xl font-bold text-text">{analytics?.homeworkCompletion || 0}%</p>
                      <div className="mt-2 text-xs text-yellow-600">-2% from last week</div>
                    </div>
                  </div>

                  <div className="bg-white shadow-sm border border-premium-neutral-200 rounded-lg p-4 mt-4">
                    <h3 className="font-medium text-text mb-4">Knowledge Mastery</h3>
                  ...
                  <div className="mt-4 bg-greyed-beige/20 p-4 rounded-lg border-l-4 border-primary">
                    ...
                    <button className="mt-3 px-3 py-1.5 bg-primary text-white rounded text-sm hover:bg-primary/90 transition-colors">
