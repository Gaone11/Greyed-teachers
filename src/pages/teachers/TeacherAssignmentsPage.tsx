          ...
          {activeTab === 'grading' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="text-sm text-greyed-blue font-semibold flex items-center gap-1 hover:underline">
              ...
              <div className="bg-greyed-navy/5 rounded-xl border border-greyed-navy/10 p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button className="bg-white border border-greyed-navy/20 text-greyed-navy px-4 py-2 rounded-lg font-semibold hover:bg-greyed-navy/5 transition-colors">
                    Grade All
                  </button>
                </div>
              </div>
                ...
                {gradingTasks.slice(1).map((task) => (
                  <div key={task.id} className="flex flex-col md:flex-row md:items-center justify-between p-4 border border-greyed-navy/10 rounded-xl hover:border-greyed-blue/30 transition-colors bg-white">
                    ...
                    <div className="flex items-center gap-3">
                      <button className="flex items-center gap-2 text-sm text-greyed-navy/70 hover:text-greyed-navy px-3 py-1.5 rounded-lg hover:bg-greyed-navy/5 transition-colors border border-transparent">
                        <FileText className="w-4 h-4" /> View Work
                      </button>
                      <button className="flex items-center gap-2 text-sm text-greyed-blue bg-greyed-blue/10 hover:bg-greyed-blue/20 px-3 py-1.5 rounded-lg transition-colors font-semibold">
