        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <Lock className="w-12 h-12 text-accent mr-4" />
          ...
          >
            ...
            <section className="border-t border-primary/10 pt-8">
              <div className="flex items-start mb-4">
                <Eye className="w-6 h-6 text-accent mr-3 mt-1 flex-shrink-0" />
                <div>
                  <h2 className="text-2xl font-headline font-bold text-primary mb-3">
            ...
            <section className="border-t border-primary/10 pt-8">
              <div className="flex items-start mb-4">
                <Lock className="w-6 h-6 text-accent mr-3 mt-1 flex-shrink-0" />
                <div>
                  <h2 className="text-2xl font-headline font-bold text-primary mb-3">
            ...
            <section className="border-t border-primary/10 pt-8">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <div className="bg-surface/20 p-6 rounded-lg space-y-3">
            ...
            <section className="border-t border-primary/10 pt-8">
              <div className="bg-primary/5 p-6 rounded-lg">
                <h3 className="font-semibold text-primary mb-3">Acknowledgment and Consent</h3>
